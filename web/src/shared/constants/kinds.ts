...
// to all three to patch local records. Mirror of lenos-core's KIND_PERSONA etc.
export const KIND_PERSONA = 30175;
export const KIND_TEAM = 30176;
export const KIND_MANAGED_AGENT = 30177;
export const KIND_USER_STATUS = 30315;
export const KIND_PRESENCE = 20010;
...
// Keep this in sync with the Home-feed mention query in lenos-db.
...
export const CHANNEL_EVENT_KINDS = [
  ...
  KIND_NIP29_DELETE_EVENT, // 9005 — NIP-29 / LenOS-native deletions
