...
test("invite requires age and legal consent before opening LenOS", async ({
  page,
}) => {
          ...
          assets: [
            {
              ...
              browser_download_url:
                "https://github.com/BuildGrowthNow/LenOS/releases/download/v0.4.9/LenOS_0.4.9_aarch64.dmg",
            },
            {
              name: "LenOS_0.4.9_x64.dmg",
              browser_download_url:
                "https://github.com/BuildGrowthNow/LenOS/releases/download/v0.4.9/LenOS_0.4.9_x64.dmg",
            },
            {
              name: "LenOS_0.4.9_amd64.AppImage",
              browser_download_url:
                "https://github.com/BuildGrowthNow/LenOS/releases/download/v0.4.9/LenOS_0.4.9_amd64.AppImage",
            },
            {
              name: "LenOS_0.4.9_x64-setup_alpha-unsigned.exe",
              browser_download_url:
                "https://github.com/BuildGrowthNow/LenOS/releases/download/v0.4.9/LenOS_0.4.9_x64-setup_alpha-unsigned.exe",
            },
          ],
        },
      ]),
