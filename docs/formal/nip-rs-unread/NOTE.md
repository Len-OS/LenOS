...
tags: [nostr, nip-rs, read-state, formal-model, lenos]
status: active
created: 2026-07-16
---
...
(below): every context ID LenOS actually generates (channel UUID,
...
**Cost:** zero bytes for every context ID LenOS generates today (channel
...
">256-byte key drop hazard" section: LenOS's own key shapes cannot
