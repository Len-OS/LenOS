...
If you discover a security vulnerability in LenOS, please report it by emailing
**lenos@block.xyz**. Include as much detail as possible:
...
LenOS is pre-1.0. We do not maintain long-term support branches at this stage.
...
All events are written to a tamper-evident audit log (`lenos-audit`). Each
...
The LenOS desktop app stores nsec private keys in the operating system keyring
...
example), keys fall back to a `0o600` owner-only file. The `LENOS_PRIVATE_KEY`
