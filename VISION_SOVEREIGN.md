# LenOS — Your Project, Your Domain
...
Next to it, a "Connect on LenOS" button.
...
You hit "Connect on LenOS" and the app opens. You're in `#general`. The team is
...
"Connect on LenOS" and they're in the community. No separate onboarding flow. No
...
portable even when the hosting isn't. And you can use LenOS as a collaboration
layer on top of GitHub if that's what makes sense — work in LenOS channels, push
...
Someone picks up the bug. They create a branch. LenOS creates a channel:
...
things are announcements. Some things are essays. LenOS has surfaces for both,
...
Onboarding friction is real — not insurmountable, but real. The "Connect on LenOS"
