...
fn is_dev_data_dir_name_rejects_prod_identifier() {
    assert!(!is_dev_data_dir_name("com.lengrowth.lenos"));
}

#[test]
fn is_dev_data_dir_name_accepts_canonical_dev_identifier() {
    assert!(is_dev_data_dir_name("com.lengrowth.lenos.dev"));
}

#[test]
fn is_dev_data_dir_name_accepts_worktree_dev_identifier() {
    assert!(is_dev_data_dir_name("com.lengrowth.lenos.dev.some-worktree"));
}
...
/// `com.lengrowth.lenos.developer` is a hypothetical prod variant, not a
/// worktree of `com.lengrowth.lenos.dev`.
#[test]
fn is_dev_data_dir_name_rejects_prefix_collision() {
    assert!(!is_dev_data_dir_name("com.lengrowth.lenos.developer"));
}
