...
fn is_dev_data_dir_name_rejects_prod_identifier() {
    assert!(!is_dev_data_dir_name("xyz.block.lenos.app"));
}

#[test]
fn is_dev_data_dir_name_accepts_canonical_dev_identifier() {
    assert!(is_dev_data_dir_name("xyz.block.lenos.app.dev"));
}

#[test]
fn is_dev_data_dir_name_accepts_worktree_dev_identifier() {
    assert!(is_dev_data_dir_name("xyz.block.lenos.app.dev.some-worktree"));
}
...
/// `xyz.block.lenos.app.developer` is a hypothetical prod variant, not a
/// worktree of `xyz.block.lenos.app.dev`.
#[test]
fn is_dev_data_dir_name_rejects_prefix_collision() {
    assert!(!is_dev_data_dir_name("xyz.block.lenos.app.developer"));
}
