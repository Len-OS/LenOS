...
fn provider_filename_strips_the_windows_extension() {
    assert_eq!(
        provider_id_from_filename("lenos-backend-kubernetes"),
        Some("kubernetes")
    );
    assert_eq!(
        provider_id_from_filename("lenos-backend-kubernetes.exe"),
        Some("kubernetes")
    );
    assert_eq!(
        provider_id_from_filename("lenos-backend-kubernetes.EXE"),
    ...
    assert_eq!(
        provider_id_from_filename("lenos-backend-kubernetes.bat"),
        Some("kubernetes")
    );
    assert_eq!(
        provider_id_from_filename("lenos-backend-kubernetes.CMD"),
        Some("kubernetes")
    );
    assert_eq!(
        provider_id_from_filename("lenos-backend-my-provider"),
        Some("my-provider")
    );
