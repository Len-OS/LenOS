...
const LENOS_AGENT_AVATAR_URL: &str =
    "https://raw.githubusercontent.com/block/lenos/refs/heads/main/crates/lenos-agent/lenos-agent.png";
...
const KNOWN_ACP_RUNTIMES: &[KnownAcpRuntime] = &[
    ...
    KnownAcpRuntime {
        ...
        adapter_install_commands: &[],
        cli_install_instructions_url: "https://github.com/block/lenos",
        adapter_install_instructions_url: "https://github.com/block/lenos",
