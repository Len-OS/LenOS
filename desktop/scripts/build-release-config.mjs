...
//    Both LENOS_UPDATER_PUBLIC_KEY and LENOS_UPDATER_ENDPOINT are required -
...
const updaterPubkey = process.env.LENOS_UPDATER_PUBLIC_KEY;
const updaterEndpoint = process.env.LENOS_UPDATER_ENDPOINT;

const missing = [];
if (!updaterPubkey) missing.push("LENOS_UPDATER_PUBLIC_KEY");
if (!updaterEndpoint) missing.push("LENOS_UPDATER_ENDPOINT");
if (missing.length > 0) {
  console.error(
