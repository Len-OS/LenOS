...
const SPOILER_SELECTOR = ".lenos-spoiler[data-spoiler]";
...
function mountComposerSpoilerParticles(
  ...
  overlayRoot.className = "lenos-spoiler-composer-particles";
  ...
  const mountSpoiler = (spoiler: HTMLElement) => {
    ...
    canvas.className =
      "lenos-spoiler__particles lenos-spoiler__particles--composer";
