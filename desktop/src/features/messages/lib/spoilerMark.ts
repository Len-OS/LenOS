...
const SPOILER_MARKDOWN_RULE = "lenos_spoiler";
const SPOILER_OPEN_TOKEN = "lenos_spoiler_open";
const SPOILER_CLOSE_TOKEN = "lenos_spoiler_close";
...
export function registerSpoilerMarkdownIt(
  ...
  md.renderer.rules[SPOILER_OPEN_TOKEN] = () =>
    '<span data-spoiler="" class="lenos-spoiler">';
