...
const CLIPBOARD_ATTRIBUTE = "data-lenos-agent-snapshot";
...
/** Build LenOS-specific clipboard HTML with the raw URL as its visible link. */
...
/** Convert a LenOS snapshot clipboard payload into one pending attachment. */
