/**
 * Relay push-policy denial token for a repository with no `lenos-channel`
 * binding. Declared in Rust as `lenos-core::git_perms::
...
const NO_CHANNEL_BINDING_COPY =
  ...
  "lenos repos bind --id <repo> --channel <channel-uuid>";
