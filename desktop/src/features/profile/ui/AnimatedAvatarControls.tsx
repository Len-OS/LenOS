...
export function AvatarFramingSlider({
  ...
  const sliderControl = (
    <div className="lenos-avatar-framing-slider-wrapper">
      <div
        ...
        aria-valuemin={min}
        aria-valuenow={value}
        className="lenos-avatar-framing-slider"
        ...
        style={
          {
            "--lenos-avatar-framing-slider-fill": `${fill}%`,
          } as React.CSSProperties
        }
        tabIndex={disabled ? -1 : 0}
      >
        <div className="lenos-avatar-framing-slider-hashmarks">
          {ticks.map((tick) => (
            <span
              aria-hidden="true"
              className="lenos-avatar-framing-slider-hashmark"
              key={tick}
              style={{
      ...
      {tipText ? (
        <p
          className="lenos-avatar-framing-slider-tip"
