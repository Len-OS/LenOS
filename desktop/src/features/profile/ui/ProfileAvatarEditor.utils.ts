...
const EMOJI_MART_SHADOW_CSS = `
  ...
  #root {
    --padding: var(--lenos-emoji-picker-padding, 16px);
    --sidebar-width: 0px;
    display: flex;
  ...
  #root::after {
    background: linear-gradient(
      to bottom,
      rgba(var(--lenos-emoji-picker-rgb-background), 0),
      rgba(var(--lenos-emoji-picker-rgb-background), 0.98)
    );
    bottom: calc(var(--lenos-emoji-picker-nav-button-size, 40px) + 24px);
    content: "";
    height: var(--lenos-emoji-picker-fade-height, 0px);
    left: 0;
    opacity: var(--lenos-emoji-picker-fade-opacity, 0);
    pointer-events: none;
    position: absolute;
    right: 0;
    z-index: 3;
  ...
  .scroll {
    ...
    padding-top: var(--lenos-emoji-picker-scroll-padding-top, 28px);
    width: 100%;
  }
  ...
  .category button[data-lenos-selected="true"] .background {
  ...
  #nav {
    ...
    flex: 0 0 auto;
    justify-content: space-between;
    padding: 8px var(--lenos-emoji-picker-nav-padding-x, 24px) 16px;
  }
  ...
  #nav button {
    ...
    display: flex;
    flex: 0 0 var(--lenos-emoji-picker-nav-button-size, 40px);
    height: var(--lenos-emoji-picker-nav-button-size, 40px);
    justify-content: center;
    transition:
      background-color var(--duration) var(--easing),
      color var(--duration) var(--easing),
      transform var(--duration) var(--easing);
    width: var(--lenos-emoji-picker-nav-button-size, 40px);
  }
  ...
  #nav svg,
  #nav img {
    height: var(--lenos-emoji-picker-category-icon-size, 24px);
    width: var(--lenos-emoji-picker-category-icon-size, 24px);
  }
`;
...
export function useEmojiMartStyles(
  ...
  React.useEffect(() => {
    ...
    const installEmojiMartStyles = () => {
      ...
      if (!shadowRoot.querySelector("#lenos-emoji-mart-style")) {
        const style = document.createElement("style");
        style.id = "lenos-emoji-mart-style";
...
export function useEmojiMartThemeVars() {
  ...
  React.useEffect(() => {
    const updateThemeVars = () => {
      ...
      setThemeVars({
        "--lenos-emoji-picker-rgb-background": muted ?? "54, 58, 79",
        "--lenos-emoji-picker-rgb-color": foreground ?? "245, 247, 255",
        "--lenos-emoji-picker-rgb-input": background ?? "47, 51, 68",
