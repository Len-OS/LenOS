...
const MODEL_DRAFT_STORAGE_KEY = "lenos.mesh-compute.share.model.v1";
const MAX_VRAM_DRAFT_STORAGE_KEY = "lenos.mesh-compute.share.max-vram-gb.v1";
        ...
        <div className="px-4 pb-4 pt-5">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-sm font-normal text-muted-foreground">
              ...
              local file. LenOS downloads remote models when sharing starts.
            </p>
...
function CatalogPicker({
  ...
  // Above the fold: the LenOS-curated picks (models known to work well with
