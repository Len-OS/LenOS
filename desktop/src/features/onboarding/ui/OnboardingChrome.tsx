 ...
 * light-blue label (`--lenos-onboarding-cta-label`, available on any
 * `.lenos-onboarding-neutral-theme` subtree).
 */
export const ONBOARDING_PRIMARY_CTA_CLASS = `${ONBOARDING_CTA_SHAPE} text-[var(--lenos-onboarding-cta-label)]`;
 ...
 * chartreuse label (`--lenos-welcome-chartreuse`). The blue label is reserved
 * for the CTAs inside the steps.
 */
export const ONBOARDING_LANDING_CTA_CLASS = `${ONBOARDING_CTA_SHAPE} text-[var(--lenos-welcome-chartreuse)]`;
 ...
 * olive backup ink (`--lenos-onboarding-backup-ink`) with a plain
...
export const ONBOARDING_INK_ICON_CLASS =
  "text-[color:var(--lenos-onboarding-backup-ink)] hover:bg-transparent hover:text-foreground";
 ...
 * static LenOS mark pinned to the top-left, and a centered pagination track that
  ...
  return (
    ...
    >
      <span className="block w-11" data-testid="onboarding-logo">
        <LenOSMark className="h-auto w-full" />
      </span>
      <div
