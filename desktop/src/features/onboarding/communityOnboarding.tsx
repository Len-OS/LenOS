...
const STORAGE_KEY = "lenos-community-onboarding-transaction.v1";
...
export function markCommunityOnboardingComplete(
  ...
  storage.setItem(
    `lenos-community-onboarding-complete.v1:${encodeURIComponent(relayUrl)}:${pubkey}`,
    "true",
  );
  ...
  storage.setItem(`lenos-onboarding-complete.v1:${pubkey}`, "true");
}
