...
export const WELCOME_CANVAS_CONTENT = `# Welcome to LenOS
...
Ask the team a question here, or read the [LenOS user guide](https://github.com/BuildGrowthNow/LenOS#readme).
`;
