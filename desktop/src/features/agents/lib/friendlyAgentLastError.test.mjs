...
test("lenos-acp wrapped auth failure → denied copy", () => {
...
test("unwrapped lenos-agent prefix → denied copy", () => {
  // lenos-agent's AgentError::LlmAuth Display is "llm auth: <body>"; if the
...
test("code -32001 → LenOS shared compute denied copy (structured path)", () => {
