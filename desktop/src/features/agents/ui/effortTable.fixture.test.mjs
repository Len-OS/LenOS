 ...
 * matches every entry. Drift between `lenosAgentConfig.ts` and the fixture
 * (e.g. a new model family added to one side but not the other) fails CI.
 * The companion Rust test in `crates/lenos-agent/src/config.rs` mirrors
...
import { getProviderEffortConfig } from "./lenosAgentConfig.ts";
