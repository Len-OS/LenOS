...
test("inheritedRows_structured_keys_excluded_from_generic_rows", () => {
  // LENOS_AGENT_PROVIDER, LENOS_AGENT_MODEL, LENOS_AGENT_THINKING_EFFORT must
  ...
  const allBaked = [
    ...
    { key: "LENOS_AGENT_MODEL", value: "goose-claude-opus-4-8", masked: false },
    { key: "LENOS_AGENT_THINKING_EFFORT", value: "medium", masked: false },
    {
      key: "DATABRICKS_HOST",
      value: "https://example.databricks.com/",
      masked: false,
