...
import { getLenOSToolInfo } from "../agentSessionToolCatalog";
...
export function ToolItem({
  ...
  const canonicalToolName = item.lenosToolName ?? item.toolName;
  const lenosTool = getLenOSToolInfo(canonicalToolName);
