 ...
 *  tree transitively imports a .css file (LenOSLogoAnimation.tsx →
 *  lenos-logo-animation.css) and the test-loader has no CSS stub. The
...
// LenOSLogoAnimation.tsx → lenos-logo-animation.css). The test below verifies the
