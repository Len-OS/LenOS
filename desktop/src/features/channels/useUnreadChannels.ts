...
const participationStore = makeRootIdStore("lenos-thread-participation.v1");
const authoredStore = makeRootIdStore("lenos-thread-authored.v1");
...
const mentionedStore = makeRootIdStore("lenos-thread-mentioned.v1");
const mutedStore = makeRootIdStore("lenos-thread-muted.v1");
...
export function useUnreadChannels(
  ...
  // (lenos-forced-unread.v1) so it survives reload and is visible to the rail
