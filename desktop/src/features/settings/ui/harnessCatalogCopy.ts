 ...
 * here. Research: ~/.lenos/RESEARCH/BYOH_CATALOG_IA.md.
 */

const HARNESS_DESCRIPTIONS: Record<string, string> = {
  // Built-in runtimes.
  "lenos-agent": "LenOS's built-in agent runtime, bundled with the app.",
  ...
  cursor: "Cursor's coding agent, connected to LenOS through its ACP server.",
  ...
  grok: "xAI's coding agent, connected to LenOS through its ACP entrypoint.",
