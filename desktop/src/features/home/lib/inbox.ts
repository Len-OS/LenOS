...
export type InboxItem = {
   ...
   * repository-scoped root for LenOS Git work. Does NOT change when a new reply
...
/**
 * Returns the stable conversation ID for any FeedItem or relay event. LenOS Git
