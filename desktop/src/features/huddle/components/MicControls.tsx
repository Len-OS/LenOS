...
const splitChevronButtonClass =
  "lenos-huddle-split-chevron group h-12 w-auto shrink-0 rounded-l-none px-2 py-4";
const MIC_PERMISSION_SETTINGS_URL =
  "x-apple.systempreferences:com.apple.preference.security?Privacy_Microphone";

type MicMeterBarStyle = CSSProperties & {
  "--lenos-huddle-meter-height": string;
};
...
function micMeterBarStyle(heightRem: number): MicMeterBarStyle {
  return { "--lenos-huddle-meter-height": `${heightRem}rem` };
}
...
export function MicControls({
  ...
  return (
    <Popover>
          ...
          <TooltipTrigger asChild>
            <Button
              ...
              className={cn(
                ...
                !isMuted && !micUnavailable && "lenos-huddle-split-main",
              )}
              onClick={() => {
            ...
            {showMicMeter ? (
              ...
              >
                <span className="flex h-5 w-5 items-center justify-between text-current group-data-[state=open]:hidden group-focus-visible:hidden group-hover:hidden">
                  <span
                    className="lenos-huddle-mic-meter-bar bg-current"
      ...
      <PopoverContent
        side="top"
        className="lenos-huddle-drawer lenos-huddle-popover w-64 text-foreground"
      >
      ...
      <div className="relative flex items-center">
        ...
        >
          ...
          <PopoverContent
            ...
            className="lenos-huddle-drawer lenos-huddle-popover lenos-huddle-headphones-hint w-64 p-3 text-foreground"
        ...
        <Button
          ...
          className={cn(
            splitIconButtonClass,
            ttsEnabled && "lenos-huddle-split-main",
          )}
          onClick={onToggleTts}
          size="icon"
