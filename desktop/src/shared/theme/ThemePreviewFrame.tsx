...
/**
 * LenOS sidebar-gradient stop tokens, keyed by theme name. The actual custom
 ...
 */
export const LENOS_GRADIENT_STOPS: Record<
  string,
  { top: string; bottom: string }
> = {
  lenos: {
    top: "var(--lenos-gradient-light-top)",
    bottom: "var(--lenos-gradient-light-bottom)",
  },
  "lenos-dark": {
    top: "var(--lenos-gradient-dark-top)",
    bottom: "var(--lenos-gradient-dark-bottom)",
  },
};
...
function SystemPreferencePreviewSvg({
  ...
  const lightGradientId = `${clipBase}-lenos-light`;
  const darkGradientId = `${clipBase}-lenos-dark`;
