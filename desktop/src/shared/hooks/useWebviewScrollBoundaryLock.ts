...
const CONVERSATION_SCROLL_SELECTOR = "[data-lenos-conversation-scroll]";
 ...
 *
 * LenOS is laid out as fixed-height nested panes. On macOS, a wheel/trackpad
 ...
 * boundaries, only containers marked with `data-lenos-conversation-scroll` are
