...
export const chromeCssVars = {
  topChromeHeight: "--lenos-top-chrome-height",
  channelContentTopPadding: "--lenos-channel-content-top-padding",
} as const;
...
export const topChromeBackdrop = {
  ...
  height: "h-(--lenos-top-chrome-height,40px)",
  /** `after:` pseudo-element offset aligned to the bottom of top chrome. */
  dividerTop: "after:top-(--lenos-top-chrome-height,40px)",
} as const;
...
export const channelChrome = {
  ...
  contentPadding: "pt-(--lenos-channel-content-top-padding,5.75rem)",
  /** Absolute/fixed top offset below the measured channel header chrome. */
  top: "top-(--lenos-channel-content-top-padding,5.75rem)",
  /** Height matching the measured channel header chrome. */
  headerHeight: "h-(--lenos-channel-content-top-padding,5.75rem)",
  /** Negative margin for overlaid channel chrome that should not affect flow. */
  negativeMargin: "-mb-(--lenos-channel-content-top-padding,5.75rem)",
} as const;
