...
/**
 * Payload emitted by the Rust deep-link handler for `lenos://message?…`.
...
/**
 * Payload emitted by the Rust deep-link handler for `lenos://join?…` —
 ...
 *
 * When a `lenos://connect?relay=<url>` link is opened, the handler
 ...
 *
 * When a `lenos://join?relay=<url>&code=<invite>` link is opened (relay
 ...
 *
 * `lenos://message?…` is handled separately by `listenForMessageDeepLinks`,
