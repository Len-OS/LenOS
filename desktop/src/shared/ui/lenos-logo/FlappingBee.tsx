...
/**
 * The LenOS bee mark with flapping wings. Geometry is identical to the static
 * {@link LenOSMark} (v8 final keyframe) — the same silhouette, rendered in
 * `currentColor` so it tints per-theme — with the wing-flap keyframes (ported
 * from the LenOS website) beating the wings on an infinite loop.
 *
