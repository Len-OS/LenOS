...
test("customEmoji is keyed by value, not identity", () => {
  clearMarkdownNodeCache();
  const emoji = [{ shortcode: "lenos", url: "https://relay/lenos.png" }];
  ...
  const second = renderCachedMarkdown({
    ...BASE,
    content: "hi :lenos:",
    customEmoji: [{ shortcode: "lenos", url: "https://relay/lenos.png" }],
  });
  assert.equal(first, second);
  ...
  const third = renderCachedMarkdown({
    ...BASE,
    content: "hi :lenos:",
    customEmoji: [{ shortcode: "lenos", url: "https://relay/other.png" }],
  });
