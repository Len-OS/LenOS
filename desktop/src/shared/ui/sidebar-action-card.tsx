...
function SidebarActionDescriptionText({
  ...
  if (shouldReduceMotion || !transition.isAnimating) {
    return (
      <span className="lenos-sidebar-action-description">
        {transition.current}
      </span>
    );
  }
  ...
  return (
    <span className="lenos-sidebar-action-description">
      ...
      <span aria-hidden className="lenos-sidebar-action-description__motion">
        <span
          className="lenos-sidebar-action-description__reel"
    ...
    >
      <button
        ...
        className={cn(
          ...
          isSuccess
            ? "lenos-sidebar-action-card--success disabled:cursor-default disabled:opacity-100"
            : surface === "secondary"
      ...
      >
        ...
        <motion.span
          className={cn(
            ...
            isSuccess
              ? "lenos-sidebar-action-card__success-icon"
