...
export const TEXTURED_SURFACE_CLASS =
  "lenos-card-textured relative isolate rounded-none border-0 bg-transparent p-[var(--lenos-card-textured-safe-inset)] shadow-none";
...
export function texturedSurfaceClasses({
  ...
  return cn(
    ...
    tone === "dark" && "lenos-card-textured-dark",
    size === "compact" && "lenos-card-textured-compact",
  );
}
 ...
 * - Default padding is the safe inset (`--lenos-card-textured-safe-inset`),
    ...
    return (
      <Comp
        ...
        className={cn(
          ...
          variant === "textured" &&
            textureTone === "dark" &&
            "lenos-card-textured-dark",
          variant === "textured" &&
            textureSize === "compact" &&
            "lenos-card-textured-compact",
        )}
        {...props}
      />
    );
