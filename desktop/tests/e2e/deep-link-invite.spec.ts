...
const TRANSACTION_STORAGE_KEY = "lenos-community-onboarding-transaction.v1";
...
const PENDING_ADD_COMMUNITY_LINK = {
  ...
  relayUrl: "wss://acme.communities.lenos.xyz",
  code: null,
  name: "Acme Team",
};
...
const SECOND_PENDING_ADD_COMMUNITY_LINK = {
  ...
  kind: "add-community" as const,
  relayUrl: "wss://beta.communities.lenos.xyz",
  code: null,
  name: "Beta Team",
};
...
test("Welcome failure retries once before allowing starter channel setup to be skipped", async ({
  ...
  const enterButton = page.getByRole("button", { name: "Take me to LenOS" });
