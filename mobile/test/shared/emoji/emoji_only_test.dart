...
const _customEmoji = [
  CustomEmoji(shortcode: 'lenos', url: 'https://example.test/lenos.png'),
];
...
void main() {
  group('isEmojiOnlyMessage', () {
    ...
    test('counts a known custom shortcode as emoji', () {
      expect(emojiOnly(':lenos:', customEmoji: _customEmoji), isTrue);
      expect(emojiOnly(':lenos: \u{1F600}', customEmoji: _customEmoji), isTrue);
      expect(emojiOnly('hi :lenos:', customEmoji: _customEmoji), isFalse);
    });
    ...
    test('an unknown shortcode is just text', () {
      ...
      expect(emojiOnly(':lenos:'), isFalse);
