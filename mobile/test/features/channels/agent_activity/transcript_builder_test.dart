...
import 'package:lenos/features/channels/agent_activity/observer_models.dart';
import 'package:lenos/features/channels/agent_activity/transcript_builder.dart';
...
void main() {
  ...
  test('normalizes lenos tool calls and applies result updates', () {
    final items = buildTranscript([
      _updateFrame(
        seq: 1,
        update: {
    ...
    expect(tool.lenosToolName, 'send_message');
  ...
  test('parses lenos prompt text into user message and metadata', () {
    final items = buildTranscript([
      ObserverFrame(
        seq: 1,
