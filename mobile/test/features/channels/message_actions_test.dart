import 'package:lenos/features/channels/message_actions.dart';
import 'package:lenos/features/channels/read_state/read_state_provider.dart';
import 'package:lenos/features/channels/thread_follows/thread_follows_provider.dart';
import 'package:lenos/features/channels/timeline_message.dart';
import 'package:lenos/shared/reminders/reminder_service.dart';
  ...
  group('messageLinkFor', () {
    test('builds a canonical link with thread context', () {
      expect(
        ...
        'lenos://message?channel=chan-1&id=msg-1&thread=root-1',
      );
    });
    ...
    test('omits thread for top-level messages', () {
      expect(
        ...
        'lenos://message?channel=chan-1&id=msg-1',
      );
    });
  });
}
