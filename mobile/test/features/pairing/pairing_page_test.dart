...
import 'package:lenos/features/pairing/pairing_page.dart';
import 'package:lenos/features/pairing/pairing_provider.dart';
import 'package:lenos/shared/theme/theme.dart';
import 'package:lenos/shared/widgets/lenos_loading_indicator.dart';
import 'package:lenos/shared/widgets/tappable_flapping_bee.dart';
...
void main() {
  group('PairingPage', () {
    testWidgets('renders branding and progressive pairing actions', (
      ...
      expect(find.text('Welcome to LenOS'), findsOneWidget);
    ...
    testWidgets('shows spinner when connecting', (tester) async {
      ...
      expect(find.byType(LenOSLoadingIndicator), findsOneWidget);
