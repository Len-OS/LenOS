...
const _clientIdKeyPrefix = 'lenos.nip-rs.client-id';
const _slotIdKeyPrefix = 'lenos.nip-rs.slot-id';
const _uuid = Uuid();

String localReadStateKey(String pubkey) => 'lenos.channel-read-state.v2:$pubkey';

String localPublishableContextKey(String pubkey) =>
    'lenos.channel-read-state.publishable.v1:$pubkey';

String localSourceCreatedAtKey(String pubkey) =>
    'lenos.channel-read-state.source-created-at.v1:$pubkey';
