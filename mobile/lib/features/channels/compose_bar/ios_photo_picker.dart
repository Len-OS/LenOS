...
const _inlinePhotoPickerViewType = 'lenos/inline_photo_picker';
const _inlinePhotoPickerSupportChannel = MethodChannel(
  'lenos/inline_photo_picker',
);
          ...
          UiKitView(
            ...
            onPlatformViewCreated: (viewId) {
              pickerChannel.value = MethodChannel(
                'lenos/inline_photo_picker/$viewId',
              );
            },
          ),
...
class _NativePhotoPickerLoading extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      width: double.infinity,
      child: const Center(
        child: LenOSLoadingIndicator(size: 44, semanticLabel: 'Opening Photos'),
      ),
    );
  }
}
