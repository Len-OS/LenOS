...
/// Routes pending `lenos://message` deep links into the channel view.
///
...
class _DeepLinkDispatcherState extends ConsumerState<DeepLinkDispatcher> {
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen<LenOSDeepLink?>(pendingDeepLinkProvider, (_, link) {
      _maybeDispatch(link);
    });
  ...
  void _maybeDispatch(LenOSDeepLink? link) {
    if (link == null) return;
