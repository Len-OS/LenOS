...
const bool mockDmDirectoryEnabled =
    kDebugMode && bool.fromEnvironment('LENOS_MOCK_DM_DIRECTORY');
...
///
/// LenOS relays use `member` tags, while older NIP-29-compatible relays may
