...
const _themeModeKey = 'lenos_theme_mode';
const _accentKey = 'lenos_accent_color';
const _schemeKey = 'lenos_color_scheme';

/// LenOS ships as the default: the first-party pair, so a fresh install gets the
/// branded top-section gradient without picking a theme first.
const defaultSchemeName = lenosThemeName;
const defaultSchemeDisplayName = 'LenOS';
