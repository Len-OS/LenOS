...
abstract final class EventKind {
  ...
  static const channelEventKinds = [
    deletion, // 5
    reaction, // 7
    nip29DeleteEvent, // 9005 — LenOS-native deletion
...
class NostrFilter {
  ...
  /// LenOS relay bridge filter extensions (for example NIP-CW `top_level`).
...
/// Parse a LenOS command response from the relay's OK message content.
///
