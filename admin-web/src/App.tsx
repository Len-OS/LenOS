...
function Reports() {
  ...
  return (
    <Page
      eyebrow="Moderation"
      title="Open reports"
      description="Review reports across every LenOS community."
    >
...
function FeedbackList() {
  ...
  return (
    <Page
      eyebrow="Product"
      title="Feedback"
      description="Recent product feedback from across LenOS."
    >
      <StateView resource={resource}>
        {(items) => {
...
const FEEDBACK_STATUS_KEY = "lenos-admin-feedback-status";
