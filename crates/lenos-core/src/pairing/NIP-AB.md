...
```bash
tamarin-prover --prove crates/lenos-core/src/pairing/NIP-AB.spthy
```
...
Implementations MUST validate against these vectors. They can be reproduced with `lenos-pair test-vectors`.
