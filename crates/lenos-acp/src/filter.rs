...
///   `str_ends_with`, `str_len` (duplicated intentionally from lenos-workflow).
...
/// `str_len` — duplicated from lenos-workflow intentionally so this crate
/// has no runtime dependency on lenos-workflow.
