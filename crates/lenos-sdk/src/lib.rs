#![deny(unsafe_code)]
#![warn(missing_docs)]
//! `lenos-sdk` — typed Nostr event builders for LenOS operations.
//!
//! # Mental Model
//!
//! ```text
...
/// Re-export kind constants so consumers don't need lenos-core directly.
pub use lenos_core::kind;
...
pub use lenos_core::channel::canonical_channel_name;
/// Channel type.
pub use lenos_core::channel::ChannelType as ChannelKind;
/// Channel visibility.
pub use lenos_core::channel::ChannelVisibility as Visibility;
/// Member role.
pub use lenos_core::channel::MemberRole;
