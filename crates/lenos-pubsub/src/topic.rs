...
/// Redis key prefix for LenOS-scoped pub/sub topics and keys.
pub const LENOS_PREFIX: &str = "lenos";
    ...
    pub fn redis_channel(&self) -> String {
        match self.topic {
            EventTopic::Channel(channel_id) => {
                format!("{LENOS_PREFIX}:{}:channel:{channel_id}", self.community_id)
            }
            EventTopic::Global => format!("{LENOS_PREFIX}:{}:global", self.community_id),
        }
    }
...
mod tests {
    ...
    fn channel_key_includes_community_and_channel() {
        ...
        assert_eq!(
            ...
            format!("lenos:{}:channel:{channel_id}", ctx.community())
        );
    }
    ...
    fn parses_channel_topic() {
        ...
        let channel_id = Uuid::from_u128(0xbbbb);
        let raw = format!("lenos:{community_id}:channel:{channel_id}");
    ...
    fn parses_global_topic() {
        let community_id = CommunityId::from_uuid(Uuid::from_u128(0xaaaa));
        let raw = format!("lenos:{community_id}:global");
    ...
    fn rejects_malformed_or_wrong_prefix_topics() {
        for raw in [
            "",
            "not-lenos:00000000-0000-0000-0000-00000000aaaa:global",
            "lenos:not-a-uuid:global",
            "lenos:00000000-0000-0000-0000-00000000aaaa",
            "lenos:00000000-0000-0000-0000-00000000aaaa:global:extra",
            "lenos:00000000-0000-0000-0000-00000000aaaa:channel",
            "lenos:00000000-0000-0000-0000-00000000aaaa:channel:not-a-uuid",
            "lenos:00000000-0000-0000-0000-00000000aaaa:presence:abc",
        ] {
            assert!(
