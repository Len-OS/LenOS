...
//! (LENOS-SEC-007 class, reported 2026-07-27).
//!
...
//!   DATABASE_URL=postgres://lenos:lenos_dev@localhost:5432/lenos_relay_admin_regression \
//!   cargo test -p lenos-test-client --test regression_relay_admin_ban_gate \
//!     -- --ignored --nocapture
