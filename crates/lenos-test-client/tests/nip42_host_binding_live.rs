...
//! # Run one binary, LENOS_HEALTH_PORT=8180 LENOS_METRICS_PORT=9202,
//! # LENOS_RECONCILE_CHANNELS=false, LENOS_GIT_CONFORMANCE_PROBE=false
//! ```
//!
//! Each test is `#[ignore]` so it only runs explicitly:
//! `cargo test -p lenos-test-client --test nip42_host_binding_live -- --ignored --test-threads=1`
