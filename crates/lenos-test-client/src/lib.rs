...
//! Minimal NIP-01 WebSocket test client for the LenOS relay.
...
/// WebSocket test client for integration testing against a running LenOS relay.
pub struct LenOSTestClient {
    inner: NostrWsConnection,
}

impl LenOSTestClient {
