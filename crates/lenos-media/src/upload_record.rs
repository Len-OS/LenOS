...
//! `LENOS_MEDIA_UPLOAD_RECORDS`. IP collection is a second, independent opt-in
//! (`LENOS_MEDIA_UPLOAD_IP_HEADER`) and is *fail-empty*: a missing, malformed,
...
//!
//! ## Consumer contract (lenos-moderation)
//!
...
pub struct UploadRecord {
    ...
    /// Present only when `LENOS_MEDIA_UPLOAD_IP_HEADER` is set AND the header
