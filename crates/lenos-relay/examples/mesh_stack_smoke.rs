...
//!
//! Crash report (2026-07-08, lenos-desktop 0.3.46): enabling Share compute
...
//!
//!   cargo run -p lenos-relay --example mesh_stack_smoke
...
/// Must match `lenos_lib::mesh_llm::MESH_WORKER_STACK_SIZE` (desktop crate is
/// not a dependency of lenos-relay, so the value is duplicated here).
