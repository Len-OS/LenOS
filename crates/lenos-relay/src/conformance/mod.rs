...
//! from `lenos-conformance`. See `crates/lenos-conformance/src/lib.rs` for
...
///   [`lenos_db::LenOS::communities_of_channels`]). On a hit, return the
...
fn project_row_community(
    ...
    channel_communities: &std::collections::HashMap<Uuid, lenos_core::CommunityId>,
...
/// [`lenos_db::LenOS::communities_of_channels`] over the distinct
/// channel ids in `rows`.
