...
pub async fn accept(
    ...
    event: &Event,
    now: i64,
) -> Result<lenos_db::push::AcceptLeaseOutcome, AcceptError> {
    ...
    let limits = LeaseLimits {
        ...
        app_profiles: &[
            AppProfile {
                id: "lenos-ios-production",
                transport: "apns",
            },
            AppProfile {
                id: "lenos-ios-sandbox",
                transport: "apns",
            },
        ],
    ...
    let version = lenos_db::push::LeaseVersion {
    ...
    let active = if body.active {
        ...
        Some(lenos_db::push::ActiveLease {
