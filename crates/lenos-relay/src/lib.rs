#![deny(unsafe_code)]
#![warn(missing_docs)]
//! NIP-01 WebSocket relay for LenOS private team communication.
...
/// `docs/spec/MultiTenantRelay.tla` by the independent `lenos-conformance`
/// checker.
pub mod conformance;
...
/// Inter-relay mesh startup wiring (`LENOS_MESH` seam).
pub mod mesh_boot;
...
/// Workflow action sink — relay-side implementation of [`lenos_workflow::ActionSink`].
