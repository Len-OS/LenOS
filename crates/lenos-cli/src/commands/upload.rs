...
pub async fn dispatch(cmd: crate::UploadCmd, client: &LenOSClient) -> Result<(), CliError> {
    match cmd {
...
pub async fn dispatch_media(cmd: crate::MediaCmd, client: &LenOSClient) -> Result<(), CliError> {
    match cmd {
