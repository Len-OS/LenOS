...
pub fn sdk_err(e: lenos_sdk::SdkError) -> CliError {
    match e {
        lenos_sdk::SdkError::InvalidInput(msg) => CliError::Usage(msg),
...
mod tests {
    ...
    // and `normalize_mention_pubkeys` live in `lenos_sdk::mentions` and are tested there.
