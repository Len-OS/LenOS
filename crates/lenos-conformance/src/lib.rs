...
/// trace schema.
///
/// This deliberately does NOT reuse `lenos_core::CommunityId`. Two reasons:
///
/// 1. **Production fence preservation.** `lenos_core::CommunityId` has no
...
impl CommunityLabel {
    /// Wrap a UUID into a community label. Unlike `lenos_core::CommunityId`
