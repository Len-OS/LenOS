//! Immutable capabilities for LenOS Desktop's April Pocket TTS bundle.
...
/// Capabilities of LenOS Desktop's sole Pocket model.
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
...
/// Return immutable metadata for LenOS Desktop's April INT8 model.
