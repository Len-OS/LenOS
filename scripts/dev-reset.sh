...
# Installed LenOS state is preserved.
# =============================================================================
set -euo pipefail
...
if [[ "${1:-}" != "--yes" ]]; then
  ...
  echo -e "   Installed LenOS app state and its production keyring are preserved."
...
success "Desktop development state removed (installed LenOS state preserved)"
