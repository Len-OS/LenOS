...
[[ "$repo" == "BuildGrowthNow/LenOS" ]] || fail "candidate publishing is restricted to BuildGrowthNow/LenOS"
...
message="LenOS Mobile $version release candidate $candidate_number"
tag_object_sha="$(
...
printf 'Published %s at %s through lenos-release-bot.\n' "$tag" "$target_sha"
