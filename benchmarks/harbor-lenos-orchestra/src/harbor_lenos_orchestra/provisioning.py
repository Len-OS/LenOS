"""Typed boundary between the Harbor adapter and LenOS trial provisioning."""
...
class AgentCredential:
    """One trial-scoped LenOS identity and attributed LLM credential."""
...
@dataclass(frozen=True, slots=True)
class TrialHandle:
    """Provisioned LenOS resources owned by one Harbor trial."""
...
class TrialProvisioner(Protocol):
    """Creates and tears down trial-isolated LenOS resources synchronously."""
