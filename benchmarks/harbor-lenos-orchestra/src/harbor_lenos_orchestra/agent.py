"""Harbor custom-agent entry point for LenOS orchestration."""
...
from .container_runtime import LenOSContainerRuntime, EndpointLaunchConfig
from .manifest import ExperimentManifest
from .provisioning import TrialProvisioner
from .runtime import OrchestraRuntime


class LenOSOrchestraAgent(BaseAgent):
    """Coordinate an arbitrary manifest-defined team through a LenOS trial."""
    ...
    def _build_runtime(
        ...
        lenos_acp_binary: str,
        lenos_agent_binary: str,
        lenos_dev_mcp_binary: str,
        lenos_cli_binary: str,
        relay_gateway: str,
        ...
        return LenOSContainerRuntime(
            ...
            endpoints=endpoints,
            lenos_acp_binary=lenos_acp_binary,
            lenos_agent_binary=lenos_agent_binary,
            lenos_dev_mcp_binary=lenos_dev_mcp_binary,
            lenos_cli_binary=lenos_cli_binary,
    ...
    async def run(
        ...
        if self.provisioner is None or self.runtime is None:
            raise RuntimeError(
                "LenOSOrchestraAgent requires provisioner and runtime integrations; "
        ...
        context.metadata = {
            **result.metadata,
            ...
            "lenos_channel_id": handle.channel_id,
            "run_id": run_id,
            "trial_id": trial_id,
        }
