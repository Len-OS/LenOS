...
--     (crates/lenos-db/src/push.rs: accept_lease_event and replace_lease).
...
--   * Lock key domain 'lenos_push_gate:' is distinct from the audit lock
--     ('lenos_audit:') and both lease-address lock families.
